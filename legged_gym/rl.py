...
class ActorCritic(nn.Module):
    ...
    def __init__(
        ...
        # seeseedms that we get better performance without init
...
class OnPolicyRunner:
    ...
    def __init__(self, env, train_cfg, log_dir=None, device="cpu", wandb=None):
        ...
        actor_critic = ActorCritic(self.env.num_obs, num_critic_obs, self.env.num_actions, **self.policy_cfg).to(
            self.device
        )
